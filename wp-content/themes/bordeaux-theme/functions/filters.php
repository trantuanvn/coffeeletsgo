...
function OT_fields_rules($fields) {
	$fields['rules'] = '<p class="contact-info"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x"></i><i class="fa fa-info fa-stack-1x fa-inverse"></i></span>'.__("Your e-mail address will not be published.", THEME_NAME).'<br/>'.__("Required fields are marked", THEME_NAME).'<span class="required">*</span></p>';
	print $fields['rules'];
}
