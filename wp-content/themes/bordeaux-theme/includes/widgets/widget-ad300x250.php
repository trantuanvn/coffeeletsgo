...
class tz_ad300_widget extends WP_Widget {
	...
	function TZ_Ad300_Widget() {
		...
		$control_ops = array( 'width' => 250, 'height' => 250, 'id_base' => 'tz_ad300_widget' );

		/* Create the widget */
		$this->WP_Widget( 'tz_ad300_widget', __(THEME_FULL_NAME.' Custom 250x250 Ad', 'framework'), $widget_ops, $control_ops );
	}
